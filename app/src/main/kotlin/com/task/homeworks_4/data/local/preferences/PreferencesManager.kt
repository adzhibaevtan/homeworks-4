package com.task.homeworks_4.data.local.preferences

import android.content.SharedPreferences
import com.task.homeworks_4.data.local.preferences.Constants.AGE
import com.task.homeworks_4.data.local.preferences.Constants.HAS_USER_SEEN_ON_BOARDING
import com.task.homeworks_4.data.local.preferences.Constants.IS_AUTHENTICATED
import com.task.homeworks_4.data.local.preferences.Constants.NAME
import com.task.homeworks_4.data.local.preferences.Constants.PROFILE_IMAGE_PATH
import com.task.homeworks_4.data.local.preferences.Constants.VERIFICATION_ID
